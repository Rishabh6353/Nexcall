...
export default function VideoMeetComponent() {
  ...
  let [video, setVideo] = useState(videoAvailable);
  ...
  let handleVideo = () => {
    ...
    if (videoTrack) {
      ...
      // TODO: Signal peer about track state change if needed
    }
  };
  let handleAudio = () => {
    const audioTrack = window.localStream.getTracks().find(track => track.kind === 'audio');
    if (audioTrack) {
      ...
      {askForUsername ? (
        ...
        >
          ...
          >
            ...
            {/* Local Video pinned smaller bottom-right */}
            <video
              ...
              style={{
                position: "absolute",
                bottom: "20px",
                right: showModal ? "340px" : "20px", // leave space if chat open
                width: "200px",
                height: "150px",
                borderRadius: "8px",
